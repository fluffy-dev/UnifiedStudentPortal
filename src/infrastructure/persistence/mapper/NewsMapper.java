...
public final class NewsMapper implements EntityMapper<News, Integer> {
    ...
    @Override public News fromJson(JsonValue json) {
        ...
        String publishedAtStr = MapperHelpers.readString(o, "publishedAt");
        LocalDateTime publishedAt = (publishedAtStr == null || publishedAtStr.isBlank())
                ? LocalDateTime.now()
                : LocalDateTime.parse(publishedAtStr);
        News n = new News(
